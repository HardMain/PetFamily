...
using PetFamily.Application.Volunteers.Commands.DeletePetFiles;
...
{
    public class DeletePetFilesHandlerTests : PetTestsBase
    {
        ...
        public DeletePetFilesHandlerTests(PetTestsWebFactory factory) : base(factory)
        {
