...
{
    public class UpdatePetSupportStatusHandlerTests : VolunteerTestsBase
    {
        private readonly ICommandHandler<Guid, UpdatePetSupportStatusCommand> _sut;
        public UpdatePetSupportStatusHandlerTests(VolunteerTestsWebFactory factory) : base(factory)
        {
